...
'backup': 'no', 'backupPeriod': 100, 'trackAncestry': 'no',
...
computationName = 'clune_pool_sparse_cont'
nonRSGrid = gr.Grid1d('initialPopulationType', ['sparse', 'random'])*gr.Grid1d('newIndividualsPerGeneration', [0, 1, 5])*gr.Grid1d('evolver', ['cluneSimplified', 'cluneSimplifiedWithPool']);
