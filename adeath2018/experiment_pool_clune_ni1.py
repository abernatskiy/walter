...
computationName = 'clune_pool_sparse_ni1'
nonRSGrid = gr.Grid1d('initialPopulationType', ['sparse', 'random'])*gr.Grid1d('newIndividualsPerGeneration', [1])*gr.Grid1d('evolver', ['cluneSimplified', 'cluneSimplifiedWithPool']);
parametricGrid = nonRSGrid*numTrials + gr.Grid1dFromFile('randomSeed', cr.randSeedFile, startAt=200, size=len(nonRSGrid)*numTrials)
