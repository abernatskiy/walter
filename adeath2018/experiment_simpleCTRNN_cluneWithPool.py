...
computationName = 'clune_pool'
nonRSGrid = gr.Grid1d('initialPopulationType', ['random'])*gr.Grid1d('newIndividualsPerGeneration', [0, 5])*gr.Grid1d('evolver', ['cluneSimplified', 'cluneSimplifiedWithPool']);
