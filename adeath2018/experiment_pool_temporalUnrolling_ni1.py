...
computationName = 'temporal_pool_ni1'
nonRSGrid = gr.Grid1d('initialPopulationType', ['random', 'sparse'])*gr.Grid1d('newIndividualsPerGeneration', [1])*gr.Grid1d('evolver', ['temporalUnrolling', 'temporalUnrollingVer0'])
