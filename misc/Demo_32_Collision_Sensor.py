...
col_sen = sim.send_global_collision_sensor(1., logarithmic=False)
...
col_data = sim.get_sensor_data(col_sen)

state_ts = zip(lin_data, rot_data, adh_data, tet_data_0, tet_data_1, col_data)
