...
#    sim.send_fixed_joint(-1, box0) # comment this line out to see the light source rotate with the body
    light_source0, lspos_sensor0 = sim.send_light_source(box0, x=0, y=0, z=-0.15, kind_of_light=0, send_position_sensor=True)
    ...
    lspos = sim.get_sensor_data(lspos_sensor0, svi=0)
    print(lspos)
