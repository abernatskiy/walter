...
evsDefaults = \
{ 'individual': 'ctrnnDiscreteWeightsFleetOfIdenticals', 'evolver': 'cluneSimplified', 'communicator': 'parallelUnixPipe',
...
'backup': 'yes', 'backupPeriod': 100, 'trackAncestry': 'no', 'secondObjectiveProbability': 1.0, 'newIndividualsPerGeneration': 0,
...
nonRSGrid = gr.Grid1d('secondObjectiveProbability', [0.9, 1.0])*gr.Grid1d('newIndividualsPerGeneration', [0,1,4])
